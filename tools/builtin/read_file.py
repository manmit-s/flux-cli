...
class ReadFileParams(BaseModel):
    ...
    limit: int | None = Field(
        None, ge=1, description='Maximum lines to read. If not specified, read entire file'
    )


class ReadFileTool(Tools):
    name = 'read_file'
    description = ("Read the contents of a text file. Returns the file content with lihe numbers. "
    ...
    async def execute(self, invocation: ToolInvocation) -> ToolResult:
        ...
        try:
            ...
            token_count = count_tokens(output, "mistralai/mistral-small-2603")
